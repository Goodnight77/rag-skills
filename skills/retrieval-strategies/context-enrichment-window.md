...
## Related Skills
- [Semantic Chunking](../chunking/semantic-chunking.md) - Better initial chunking
- [Hierarchical Chunking](../chunking/hierarchical-chunking.md) - Structure-based approach
- [Sliding Window Chunking](../chunking/sliding-window-chunking.md) - Overlap-based chunking
