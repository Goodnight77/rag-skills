...
## Related Skills
- [HyDE](./hyde-hypothetical-document-embeddings.md) - Different query expansion approach
- [Fusion Retrieval](./hybrid-search-bm25-dense.md) - Combining multiple retrieval signals
- [Adaptive Retrieval](./adaptive-retrieval.md) - Dynamic query processing
