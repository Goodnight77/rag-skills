...
## Related Skills
- [CRAG (Corrective RAG)](../crag-corrective-rag/SKILL.md) - Dynamic correction approach
- [Adaptive Retrieval](../adaptive-retrieval/SKILL.md) - Query-based strategy selection
