...
## Related Skills
- [Hierarchical Chunking](../hierarchical-chunking/SKILL.md) - For nested document structures
- [Sliding Window Chunking](../sliding-window-chunking/SKILL.md) - For overlapping context preservation
- [Hybrid Search BM25 Dense](../../retrieval-strategies/hybrid-search-bm25-dense/SKILL.md) - Combining search methods
