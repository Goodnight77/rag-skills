...
## Related Skills
- [Qdrant for Production RAG](../../vector-databases/qdrant-for-production-rag/SKILL.md) - Production setup
- [Multi-Pass Retrieval with Reranking](../../retrieval-strategies/multi-pass-retrieval-with-reranking/SKILL.md) - Two-stage optimization
- [Hybrid Search BM25 Dense](../../retrieval-strategies/hybrid-search-bm25-dense/SKILL.md) - Query optimization
